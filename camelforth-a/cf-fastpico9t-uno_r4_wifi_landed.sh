...
# good just before 11 Dec 2023 probably: picocom -e \\ -f n -p n -d 8 -b 115200 --imap lfcrlf --omap delbs,crlf --send-cmd "ascii-xfr -sn -l 195 -c 28" ${1}

# taken from esp32 variant worked on 11 Dec 2023 for camelforth:

# picocom -e \\ -f n -p n -d 8 -b 9600 --imap lfcrlf --omap delbs,crlf --send-cmd "ascii-xfr -sn -l 195 -c 28" ${1}
